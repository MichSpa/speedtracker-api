...
SpeedTracker.prototype._buildResult = function (data) {
  ...
  let result = {
    breakdown: {},
    date: wpt.completed,
    domElements: wpt.median.firstView.domElements,
    domInteractive: wpt.median.firstView.domInteractive,
    firstPaint: wpt.median.firstView.firstPaint,
    fullyLoaded: wpt.median.firstView.fullyLoaded,
    id: wpt.id,
    loadTime: wpt.median.firstView.loadTime,
    render: wpt.median.firstView.render,
    SpeedIndex: wpt.median.firstView.SpeedIndex,
    TTFB: wpt.median.firstView.TTFB,
    ...
    visualComplete: wpt.median.firstView.visualComplete
  }

  // Add Lighthouse score
  const lighthouseScore = wpt.median.firstView['lighthouse.Performance']
